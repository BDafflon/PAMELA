...
class SnakeBody(Body):
    def __init__(self):
        Body.__init__(self)
        self.tail=[]
        self.tail.append(Vector2D(self.location.x+10,self.location.y))
        self.tail.append(Vector2D(self.location.x + 20, self.location.y))
        self.tail.append(Vector2D(self.location.x + 30, self.location.y))
